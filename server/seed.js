...
async function runSeed() {
  ...
  const useSsl = connectionString && !connectionString.includes('localhost') && !connectionString.includes('127.0.0.1') && !connectionString.includes('railway.internal');
  ...
  try {
    ...
    const yachts = [
      { id: "y1", name: "SQ - House Boat", capacity: 20, hourly_rate: 300, description: "Traditional luxury house boat experience." },
      { id: "y2", name: "SQX - 30 People Capacity", capacity: 30, hourly_rate: 600, description: "Spacious deck yacht with twin salons." },
      { id: "y3", name: "SQX - 12 People Capacity", capacity: 12, hourly_rate: 400, description: "Compact luxury cruiser ideal for small private gatherings." },
      { id: "y4", name: "Third Party Yacht (Out-Sourced)", capacity: 15, hourly_rate: 500, description: "Outsourced executive charter option." }
    ];
